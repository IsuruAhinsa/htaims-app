<x-jet-confirmation-modal wire:model="confirmingDeletion">
    ...
    <x-slot name="content">
        Would you like to delete this vendor record? By checking following permanently delete checkbox, this vendor record, all of its related resources and data will be permanently deleted. It cannot be undone.
