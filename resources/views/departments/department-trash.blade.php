<div>
    ...
    <div class="py-3 px-6 border-t dark:border-dark-third lg:flex lg:items-center lg:justify-between">
        ...
        <div class="flex-1 min-w-0">
            ...
            {{ Breadcrumbs::render('departments.trash') }}
            ...
            <li>
                ...
                <a href="{{ route('departments.index') }}">
                    ...
                    <x-action-button>
                        ...
                        <span class="hidden sm:block">{{ __('Back To Departments') }}</span>
    ...
    <div class="bg-white dark:bg-dark-secondary rounded-xl py-10 px-12 mx-4">
        ...
        <livewire:departments.department-trash-table/>

    </div>

    @include('departments.restore-confirmation-modal')

    @include('departments.force-delete-confirmation-modal')
