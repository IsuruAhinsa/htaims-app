<div>
                ...
                <li>
                    ...
                    <a href="{{ route('departments.trash') }}">
                        ...
                        <x-action-button>
                            ...
                            <span class="hidden sm:block">{{ __('Deleted Departments') }}</span>
    ...
    @include('departments.department-form-modal')

    @include('departments.delete-confirmation-modal')

    @include('departments.department-detail-panel')
