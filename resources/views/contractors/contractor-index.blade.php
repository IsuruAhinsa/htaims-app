<div>
    ...
    <div class="py-3 px-6 border-t dark:border-dark-third lg:flex lg:items-center lg:justify-between">
        ...
        <div class="flex-1 min-w-0">
            ...
            {{ Breadcrumbs::render('contractors.index') }}
        ...
        <ul class="mt-5 flex space-x-2 lg:mt-0 lg:ml-4">
            ...
            @can('contractors.view')
                ...
                <li>
                    ...
                    <a href="{{ route('contractors.trash') }}">
                        ...
                        <x-action-button>
                            ...
                            <span class="hidden sm:block">{{ __('Deleted Contractors') }}</span>
    ...
    <div class="bg-white dark:bg-dark-secondary rounded-xl py-10 px-12 mx-4">
        ...
        <livewire:contractors.contractor-table/>

    </div>

    @include('contractors.contractor-form-modal')

    @include('contractors.delete-confirmation-modal')

    @include('contractors.contractor-detail-panel')
