<div>
    ...
    <div class="py-3 px-6 border-t dark:border-dark-third lg:flex lg:items-center lg:justify-between">
        ...
        <div class="flex-1 min-w-0">
            ...
            {{ Breadcrumbs::render('contractors.trash') }}
            ...
            <li>
                ...
                <a href="{{ route('contractors.index') }}">
                    ...
                    <x-action-button>
                        ...
                        <span class="hidden sm:block">{{ __('Back To Contractors') }}</span>
    ...
    <div class="bg-white dark:bg-dark-secondary rounded-xl py-10 px-12 mx-4">
        ...
        <livewire:contractors.contractor-trash-table/>

    </div>

    @include('contractors.restore-confirmation-modal')

    @include('contractors.force-delete-confirmation-modal')
