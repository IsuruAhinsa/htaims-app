<x-livewire-powergrid::table-base
    :theme="$theme->table">
    <x-slot name="header">
        <tr class="{{ $theme->table->trClass }} dark:bg-dark-secondary dark:border-dark-third"
    ...
    <x-slot name="rows">
        ...
        @else
            @foreach($data as $row)
                <tr class="{{ $theme->table->trBodyClass }} dark:bg-dark-secondary dark:border-dark-third dark:hover:bg-dark-third"
