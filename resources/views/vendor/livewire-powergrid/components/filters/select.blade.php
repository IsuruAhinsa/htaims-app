        ...
        <div class="@if(!$inline) pt-2 p-2 @endif">
            ...
            <div class="relative">
                <select id="input_{!! data_get($select, 'data_field') !!}"
                        class="power_grid {{ $theme->inputClass }} {{ $class }} {{ data_get($column, 'headerClass') }} bg-white border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
