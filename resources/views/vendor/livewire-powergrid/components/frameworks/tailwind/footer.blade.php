        ...
        <div class="flex flex-row justify-center md:justify-start mb-2 md:mb-0">
            <div class="relative h-10">
                ...
                <select wire:model.lazy="perPage"
                        class="block appearance-none bg-white border border-gray-300 text-gray-700 py-2 px-3 pr-8 leading-tight focus:outline-none focus:bg-white dark:bg-gray-500 dark:text-gray-200 dark:placeholder-gray-200 dark:border-gray-500 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
