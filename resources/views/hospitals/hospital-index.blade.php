<div>
    ...
    <div class="py-3 px-6 border-t dark:border-dark-third lg:flex lg:items-center lg:justify-between">
        ...
        <div class="flex-1 min-w-0">
            ...
            {{ Breadcrumbs::render('hospitals.index') }}
                ...
                <li>
                    ...
                    <a href="{{ route('hospitals.trash') }}">
                        ...
                        <x-action-button>
                            ...
                            <span class="hidden sm:block">{{ __('Deleted Hospitals') }}</span>
    ...
    <div class="bg-white dark:bg-dark-secondary rounded-xl py-10 px-12 mx-4">
        ...
        <livewire:hospitals.hospital-table/>

    </div>

    @include('hospitals.hospital-form-modal')

    @include('hospitals.hospital-detail-panel')

    @include('hospitals.delete-confirmation-modal')
