<div>
            ...
            <li>
                ...
                <a href="{{ route('users.index') }}">
                    ...
                    <x-action-button>
                        ...
                        <span class="hidden sm:block">{{ __('Back To Users') }}</span>
    ...
    <div class="bg-white dark:bg-dark-secondary rounded-xl py-10 px-12 mx-4">
        ...
        <livewire:users.user-trash-table/>

    </div>

    @include('users.restore-confirmation-modal')

    @include('users.force-delete-confirmation-modal')
