<div>
            ...
            <li>
                ...
                <a href="{{ route('assets.index') }}">
                    ...
                    <x-action-button>
                        ...
                        <span class="hidden sm:block">{{ __('Back To Assets') }}</span>
    ...
    <div class="bg-white dark:bg-dark-secondary rounded-xl py-10 px-12 mx-4">
        ...
        <livewire:assets.asset-trash-table/>

    </div>

    @include('assets.restore-confirmation-modal')

    @include('assets.force-delete-confirmation-modal')
